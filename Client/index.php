...
<div class="container">
    ...
    <h2><b>Soap web service for currency conversion</b></h2>

    <br>

    <p> Welcome! <br> <br>You can convert your money esay :) </p>
    ...
    <form action="Client.php" method="post">
        ...
        <div class="form-group">
            <label for="sel1">Source Currency</label>
        ...
        <div class="form-group">
            <label for="sel2">Target Currency</label>
...
<h5>Design By Tharushi Herath (AA1824) :)</h5>
